...
// Path to the dockings page
const DOCKINGS_PATH = '/dockings';

// Base URL for the API
const API_BASE = 'http://localhost:3000/api';

// Endpoint to begin a transaction
const TRANSACTION_BEGIN_PATH = '/testing/transaction/begin';

// Endpoint to rollback a transaction
const TRANSACTION_ROLLBACK_PATH =
...
const test = baseTest.extend({
  // Add the Playwright fixture here
});
...
test.describe('Docking Schedule', () => {
  ...
  test('allows scheduling a new docking', async ({
    ...
    // Log so we we can see when the test is running
